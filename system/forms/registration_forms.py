...
from system.forms.registration_operational_forms import OperationalRegistrationFieldsMixin
...
class PortalRegistrationForm(OperationalRegistrationFieldsMixin, forms.Form):
    ...
    def save(self):
        raise NotImplementedError(
            ...
            "cadastro chama system.services.registration.create_portal_registration "
            "diretamente a partir de system.services.pre_registration.finalize_pre_registration."
        )
