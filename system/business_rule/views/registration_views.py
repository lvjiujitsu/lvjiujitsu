...
from system.business_rule.forms import PortalRegistrationForm
from system.business_rule.constants import CheckoutAction, PersonTypeCode, RegistrationProfile
from system.business_rule.models import Person, PreRegistration
from system.business_rule.models.coupon import DiscountType
...
from system.business_rule.access import login_portal_identity, portal_account
from system.business_rule.services import asaas_client
from system.business_rule.services.coupon import CouponError, apply_coupon, validate_coupon
...
from system.business_rule.services.registration_finalize import finalize_pre_registration
from system.business_rule.services.pre_registration import (
...
from system.business_rule.services.registration_validation import (
    build_eligibility_context_from_wizard_data,
)
from system.business_rule.services.operational_registration import (
...
class PortalRegisterView(FormView):
    ...
    template_name = "business_rule/login/register.html"
...
class FinalizeRegistrationView(View):
    ...
    def _finalize_pre_registration(self, request, pre_registration_id):
        ...
        access_account = result["portal_account"]
        if access_account:
            login_portal_identity(request, portal_account=access_account)
