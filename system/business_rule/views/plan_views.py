...
from system.business_rule.forms.plan_forms import PlanForm, PlanListFilterForm
from system.business_rule.models.plan import SubscriptionPlan
from system.business_rule.services.plan_management import (
    build_plan_kpis,
    build_plan_usage,
    get_plan_by_pk,
    get_plan_list,
...
class PlanListView(AdministrativeRequiredMixin, ListView):
    template_name = "business_rule/plans/plan_list.html"
...
class PlanCreateView(ModalFormMixin, AdministrativeRequiredMixin, CreateView):
    ...
    form_class = PlanForm
    template_name = "business_rule/plans/plan_form.html"
    modal_template_name = "business_rule/plans/plan_form_modal.html"
...
class PlanDetailView(AdministrativeRequiredMixin, DetailView):
    template_name = "business_rule/plans/plan_detail.html"
...
class PlanDeleteView(AdministrativeRequiredMixin, DeleteView):
    model = SubscriptionPlan
    template_name = "business_rule/plans/plan_confirm_delete.html"
    success_url = reverse_lazy("system:plan-list")
    context_object_name = "plan"
