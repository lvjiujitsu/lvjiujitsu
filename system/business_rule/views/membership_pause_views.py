...
from system.business_rule.forms import MembershipPauseDecisionForm, MembershipPauseRequestForm
...
from system.business_rule.services.membership_pause import (
...
class MembershipPauseRequestQueueView(PortalRoleRequiredMixin, ListView):
    ...
    template_name = "business_rule/membership_pauses/pause_request_list.html"
...
class MembershipPauseRequestDetailView(PortalRoleRequiredMixin, DetailView):
    model = MembershipPauseRequest
    template_name = "business_rule/membership_pauses/pause_request_detail.html"
