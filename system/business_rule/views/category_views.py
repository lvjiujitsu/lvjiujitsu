...
from system.business_rule.forms import ClassCategoryForm
...
class ClassCategoryListView(AdministrativeRequiredMixin, ListView):
    model = ClassCategory
    template_name = "business_rule/class_categories/class_category_list.html"
...
class ClassCategoryCreateView(ModalFormMixin, AdministrativeRequiredMixin, CreateView):
    ...
    template_name = "business_rule/class_categories/class_category_form.html"
...
class ClassCategoryDetailView(AdministrativeRequiredMixin, DetailView):
    model = ClassCategory
    template_name = "business_rule/class_categories/class_category_detail.html"
