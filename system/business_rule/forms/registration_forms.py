...
class PortalRegistrationForm(OperationalRegistrationFieldsMixin, forms.Form):
    ...
    holder_martial_art_started_at = forms.DateField(required=False, input_formats=PT_BR_DATE_INPUT_FORMATS)
    holder_martial_art_last_graduation_at = forms.DateField(required=False, input_formats=PT_BR_DATE_INPUT_FORMATS)
    ...
    dependent_martial_art_started_at = forms.DateField(required=False, input_formats=PT_BR_DATE_INPUT_FORMATS)
    dependent_martial_art_last_graduation_at = forms.DateField(required=False, input_formats=PT_BR_DATE_INPUT_FORMATS)
    ...
    guardian_martial_art_started_at = forms.DateField(required=False, input_formats=PT_BR_DATE_INPUT_FORMATS)
    guardian_martial_art_last_graduation_at = forms.DateField(required=False, input_formats=PT_BR_DATE_INPUT_FORMATS)
    ...
    student_martial_art_started_at = forms.DateField(required=False, input_formats=PT_BR_DATE_INPUT_FORMATS)
    student_martial_art_last_graduation_at = forms.DateField(required=False, input_formats=PT_BR_DATE_INPUT_FORMATS)
    ...
    other_martial_art_started_at = forms.DateField(required=False, input_formats=PT_BR_DATE_INPUT_FORMATS)
    other_martial_art_last_graduation_at = forms.DateField(required=False, input_formats=PT_BR_DATE_INPUT_FORMATS)
