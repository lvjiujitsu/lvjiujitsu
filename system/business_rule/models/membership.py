...
class Membership(TimeStampedModel):
    ...
    plan = models.ForeignKey(
        "business_rule.SubscriptionPlan",
    ...
    stripe_subscription_item_id = models.CharField(
        "ID do item da assinatura Stripe",
        max_length=255,
        blank=True,
        default="",
    )
    ...
    def recompute_billed_price(self, *, tier):
...
class MembershipCredit(TimeStampedModel):
    ...
    source_order = models.ForeignKey(
        "business_rule.RegistrationOrder",
