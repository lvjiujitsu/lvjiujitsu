...
from system.business_rule.models import BeltRank, GraduationRule
...
class Command(BaseCommand):
    help = f"Cria as regras de graduação a partir de static/business_rule/initial_data/{DATA_FILENAME}."
