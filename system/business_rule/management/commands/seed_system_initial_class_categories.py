...
from system.business_rule.models import ClassCategory


DATA_FILENAME = "seed_system_initial_class_categories.json"


class Command(BaseCommand):
    help = f"Cria as categorias de turma a partir de static/business_rule/initial_data/{DATA_FILENAME}."
