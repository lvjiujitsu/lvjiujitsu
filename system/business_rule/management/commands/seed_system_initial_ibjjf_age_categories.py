...
from system.business_rule.models import IbjjfAgeCategory
...
class Command(BaseCommand):
    help = f"Cria as categorias de idade IBJJF a partir de static/business_rule/initial_data/{DATA_FILENAME}."
