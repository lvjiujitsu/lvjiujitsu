...
from system.business_rule.models.plan import BillingCycle, PlanPaymentMethod, PlanPrice, PlanTier
from system.business_rule.services.stripe_sync import StripeSyncError, sync_plan_to_stripe
...
class Command(BaseCommand):
    help = f"Cria os preços por tier x forma de pagamento x ciclo a partir de static/business_rule/initial_data/{DATA_FILENAME}."
