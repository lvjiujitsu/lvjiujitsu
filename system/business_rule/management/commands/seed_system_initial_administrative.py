...
from system.business_rule.models import ClassCategory, Person, PersonType, PortalAccount
...
class Command(BaseCommand):
    help = "Cria usuários administrativos iniciais a partir de static/business_rule/initial_data/seed_system_initial_administrative.json."
    ...
    def handle(self, *args, **options):
        ...
        if not data:
            self.stdout.write(self.style.WARNING(
                "Nenhum usuário encontrado no arquivo seed_system_initial_administrative.json."
            ))
            return
