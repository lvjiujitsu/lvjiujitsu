...
from system.business_rule.models import ClassCategory, ClassGroup, ClassSchedule, Person
...
class Command(BaseCommand):
    help = f"Cria turmas e horários a partir de static/business_rule/initial_data/{DATA_FILENAME}."
