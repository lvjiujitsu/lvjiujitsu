...
class Command(BaseCommand):
    help = (
        ...
        "static/business_rule/initial_data/seed_system_initial_administrative.json. "
    ...
    def handle(self, *args, **options):
        ...
        if not entries:
            self.stdout.write(self.style.WARNING(
                "Nenhum administrativo com turmas definidas em seed_system_initial_administrative.json."
            ))
            return
