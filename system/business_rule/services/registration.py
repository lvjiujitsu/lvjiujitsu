...
from system.business_rule.services.graduation import ensure_initial_graduation_for_beginner
from system.business_rule.services.registration_checkout import create_registration_order
...
from system.business_rule.models import BeltRank, Graduation
...
def _create_holder_registration(cleaned_data, person_types):
    holder = create_person_with_account(
...
def _create_guardian_registration(cleaned_data, person_types):
    guardian = create_person_with_account(
        ...
        blood_type=cleaned_data.get("guardian_blood_type", ""),
        allergies=cleaned_data.get("guardian_allergies", ""),
        previous_injuries=cleaned_data.get("guardian_injuries", ""),
        emergency_contact=cleaned_data.get("guardian_emergency_contact", ""),
        martial_art=cleaned_data.get("guardian_martial_art", ""),
        martial_art_graduation=cleaned_data.get("guardian_martial_art_graduation", ""),
        jiu_jitsu_belt=cleaned_data.get("guardian_jiu_jitsu_belt", ""),
        jiu_jitsu_stripes=cleaned_data.get("guardian_jiu_jitsu_stripes"),
        martial_art_started_at=cleaned_data.get("guardian_martial_art_started_at"),
        martial_art_last_graduation_at=cleaned_data.get("guardian_martial_art_last_graduation_at"),
        previous_academy=cleaned_data.get("guardian_previous_academy", ""),
...
def _create_other_registration(cleaned_data, person_types):
    ...
    other_person = create_person_with_account(
...
def create_person_with_account(
    *,
    full_name,
    cpf,
    password,
