...
from system.business_rule.models.pre_registration import PreRegistrationStatus
from system.business_rule.services.pre_registration import (
    grant_trial_for_pre_registration,
    normalize_snapshot_for_form,
)
from system.business_rule.services.registration import create_portal_registration
