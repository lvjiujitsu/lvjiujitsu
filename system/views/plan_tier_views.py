...
from system.forms.plan_tier_forms import (
    PlanPriceForm,
    PlanTierForm,
    PlanTierListFilterForm,
)
from system.models.plan import PlanPrice, PlanTier
from system.services.plan_tier_management import (
...
class PlanTierListView(AdministrativeRequiredMixin, ListView):
    template_name = "plans/tier_list.html"
...
class PlanTierCreateView(ModalFormMixin, AdministrativeRequiredMixin, CreateView):
    ...
    template_name = "plans/tier_form.html"
    modal_template_name = "plans/tier_form_modal.html"
...
class PlanTierDetailView(AdministrativeRequiredMixin, DetailView):
    template_name = "plans/tier_detail.html"
...
class PlanTierDeleteView(AdministrativeRequiredMixin, DeleteView):
    model = PlanTier
    template_name = "plans/tier_confirm_delete.html"
    success_url = reverse_lazy("system:plan-tier-list")
    context_object_name = "tier"
...
class PlanPriceCreateView(ModalFormMixin, AdministrativeRequiredMixin, CreateView):
    ...
    template_name = "plans/price_form.html"
    modal_template_name = "plans/price_form_modal.html"
...
class PlanPriceDeleteView(AdministrativeRequiredMixin, DeleteView):
    model = PlanPrice
    template_name = "plans/price_confirm_delete.html"
