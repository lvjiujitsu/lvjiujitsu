...
from system.forms import AdministrativeAccessDecisionForm, AdministrativeAccessRequestForm
...
class PortalAdministrativeAccessRequestCreateView(PortalLoginRequiredMixin, FormView):
    ...
    def get_form_kwargs(self):
        ...
        kwargs["portal_person"] = getattr(self.request, "portal_person", None)
...
class AdministrativeAccessRequestQueueView(PortalRoleRequiredMixin, ListView):
    ...
    template_name = "access_requests/request_list.html"
